...
namespace eCommerceApp.Application.Services.Implementations
{
    public class CategoryService(IGeneric<Category> categoryInterface, IMapper mapper,ICategory categorySpecifics) : ICategoryService
    {
        ...
        public async Task<ServiceResponse> DeleteAsync(Guid id)
        {
            ...
            return result > 0 ? new ServiceResponse(true, "Category deleted!") : new ServiceResponse(false, "Category not found and could not be deleted!");
        }
        ...
        public async Task<ServiceResponse> UpdateAsync(UpdateCategory category)
        {
            ...
            return result > 0 ? new ServiceResponse(true, "Category updated!") : new ServiceResponse(false, "Category not updated!");
        }
    }
}
