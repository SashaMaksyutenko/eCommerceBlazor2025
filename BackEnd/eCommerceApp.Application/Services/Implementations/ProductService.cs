...
namespace eCommerceApp.Application.Services.Implementations
{
    public class ProductService(IGeneric<Product> productInterface, IMapper mapper) : IProductService
    {
        ...
        public async Task<ServiceResponse> DeleteAsync(Guid id)
        {
            ...
            return result > 0 ? new ServiceResponse(true, "Product deleted!") : new ServiceResponse(false, "Product not found and could not be deleted!");
        }
        ...
        public async Task<ServiceResponse> UpdateAsync(UpdateProduct product)
        {
            ...
            return result > 0 ? new ServiceResponse(true, "Product updated!") : new ServiceResponse(false, "Product not updated!");
        }
    }
}